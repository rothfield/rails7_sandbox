class CheckpointsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @checkpoint.save
        format.html { redirect_to checkpoint_url(@checkpoint), notice: "Checkpoint was successfully created." }
  ...
  def update
    respond_to do |format|
      if @checkpoint.update(checkpoint_params)
        format.html { redirect_to checkpoint_url(@checkpoint), notice: "Checkpoint was successfully updated." }
  ...
  private
    ...
    def checkpoint_params
      params.require(:checkpoint).permit(:name, :code, :checkpoint_category_id)
    end
end
